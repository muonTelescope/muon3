...
\usepackage{hyperref}
\usepackage{float}
% siunitx may need tlmgr on minimal TeX; amsmath/amssymb for \text, \lesssim, etc.
%\usepackage{siunitx}
\usepackage{amsmath}
\usepackage{amssymb}
...
Results (openEMS Python scripts in \texttt{sim/openems/}; 2D plots in \texttt{figures/openems/}; detailed \textbf{Octave 3D} surfaces in \texttt{figures/octave/}):
...
\end{minipage}
\caption{nRF9151 antenna S11 (left) and polar pattern (right) from openEMS-enabled simulation.}
\end{figure}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_nrf9151_pattern_3d.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_nrf9151_s11_3d.png}
\end{minipage}
\caption{\label{fig:octave-rf}Octave 3D RF views: nRF9151 radiation pattern surface (left) and S11 vs frequency/azimuth model surface (right). Generated with \texttt{sim/plots\_octave/plot\_3d\_openems\_geant4.m}.}
\end{figure}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_cable_s21_3d.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_cable_s11_3d.png}
\end{minipage}
\caption{Octave 3D cable surfaces: $S_{21}$ (left) and $S_{11}$ (right) versus frequency and cable length, extrapolated from the 50\,cm openEMS S-parameter CSV.}
\end{figure}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_hs_trace_z0_3d.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_pdn_z_3d.png}
\end{minipage}
\caption{Octave 3D SI/PI views: microstrip $Z_0$ vs frequency and width (left); PDN $|Z|$ surface vs frequency and decoupling capacitance (right).}
\end{figure}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_hcal_edep_surf_3d.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_hcal_pe_surf_3d.png}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_hcal_scatter_3d.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/octave/octave_hcal_pe_surface_3d.png}
\end{minipage}
\caption{\label{fig:octave-g4}Octave 3D Geant4 views for the HCal tile (S12572): $E_\mathrm{dep}(x,y)$ surface, $N_\mathrm{p.e.}(x,y)$ surface, impact vs.\ edep scatter, and $N_\mathrm{p.e.}$ vs.\ edep/position. Generated with GNU Octave (\texttt{sim/plots\_octave/plot\_3d\_openems\_geant4.m}) from \texttt{hcal\_tile\_hits.csv}.}
\end{figure}
