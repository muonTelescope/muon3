...
\end{minipage}
\caption{\label{fig:hcal-g4}Geant4 results for Inner HCal tile~01 with \textbf{Hamamatsu S12572-33-015P} readout (200 MIP-like muons): energy deposit spectrum, detected photoelectron spectrum (PDE~$=0.25$, effective collection), mean edep vs.\ impact position, and summary histograms. Data: \texttt{sim/geant4/hcal\_tile\_hits.csv}.}
\end{figure}
