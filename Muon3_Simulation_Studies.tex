...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/muon3_panel_isometric.png}
\caption{Blender render of the Muon3 scintillator panel concept: EJ-200 plate (blue translucent), looped WLS fiber (green emissive), SiPM readout (dark), and base/PCB holder. (Procedural model for visualization.)}
\end{figure}
...
\begin{itemize}
  \item nRF9151 antenna: S11 across GNSS (1.575 GHz) and LTE bands (1.8/2.6 GHz). Synthetic model shows good matching with peaks as expected; radiation pattern dipole-like.
