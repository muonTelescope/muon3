...
\begin{itemize}
  ...
  \item a 3$\times$3~mm$^2$ SiPM body.
\end{itemize}
...
A Geant4 run of 200 cosmic-like $\mu^-$ events on tile~01 (tessellated solid + fiber + coating + wrap + blocker + SiPM, optical physics enabled) yields a mean scintillator energy deposit of $\approx 2.04$~MeV (RMS $\approx 0.78$~MeV) and a mean of $\approx 55$ detected photoelectrons after a flat SiPM PDE of 0.38. Position-dependent edep and p.e.\ distributions are shown in Figure~\ref{fig:hcal-g4}.
...
\end{minipage}
\caption{\label{fig:hcal-g4}Geant4 results for Inner HCal tile~01 assembly (200 MIP-like muons): energy deposit spectrum, detected photoelectron spectrum, mean edep vs.\ impact position, and summary histograms. Data: \texttt{sim/geant4/hcal\_tile\_hits.csv}.}
\end{figure}
...
C.A. Aidala et al. (sPHENIX Collaboration), ``Design and Beam Test Results for the sPHENIX Electromagnetic and Hadronic Calorimeter Prototypes,'' IEEE Trans.\ Nucl.\ Sci.\ 65 (2018) 2901 [arXiv:1704.01461]. Local PDF: \texttt{reference\_documentation/publications/sPHENIX\_2018\_Design\_and\_Beam\_Test.pdf}.
